      ...
      <div className="max-w-7xl mx-auto px-6 pt-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#08075C]">Save Projects</h2>
            </div>
            <h1 className="text-4xl font-black text-[#08075C] tracking-tight">Saved Projects</h1>
        ...
        {displayedFavorites.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 bg-white rounded-[3rem] border border-dashed border-gray-200 shadow-sm">
            ...
            <h3 className="text-lg font-bold text-[#08075C] mb-2">No Saved projects yet</h3>
