  ...
  return (
    <aside className="w-64 min-h-screen bg-white border-r border-gray-100 flex flex-col fixed left-0 top-0 z-50">
      ...
      <div className="p-6 border-t border-gray-50">
        <Link href="/auth/logout" className="flex items-center gap-4 px-4 py-3 w-full text-[#667085] font-bold hover:text-red-500 hover:bg-red-50 rounded-xl transition-all group">
