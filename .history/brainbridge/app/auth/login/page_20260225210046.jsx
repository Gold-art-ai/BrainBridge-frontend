        ...
        <div className="main-card flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 p-8 sm:p-12 md:p-16">
            ...
            <div className="space-y-6">
              ...
              <button href="/dashboard" className="btn-brand w-full text-white py-4 rounded-2xl font-bold text-lg shadow-xl mt-4 active:scale-95 transition-all inline-block text-center">
                Sign In
              </Link>
            </div>
          </div>
